...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <div class="navbar shadow bg-base-100">
        ...
        <div class="flex-none">
            ...
            <?php $__currentLoopData = $carrinho; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrinho): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div tabindex="0" class="mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow">
                <div class="card-body">
                <span class="font-bold text-lg"><?php echo e($carrinho->quantidade); ?></span>
                <span class="text-info">Subtotal: <?php echo e($carrinho->valor); ?></span>
    ...
    <div class="cards flex static ">
        <div class="card w-96 m-2 bg-base-100 shadow-xl">
            ...
            <div class="card-body items-center text-center">
                ...
                <h3 class="font-bold"><?php echo e($produto->valor); ?></h3>
                <div class="card-actions">
...
<?php /**PATH C:\Users\ana.abrantes\Desktop\projetos\e-commerce-main\ecomerce\resources\views/index.blade.php ENDPATH**/ ?>