...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <div class="hero-content flex-col lg:flex-row-reverse">
        ...
        <form class="card-body" action="<?php echo e(route('user.store')); ?>" method="POST">
...
</html><?php /**PATH C:\Users\LENOVO\Desktop\ecomerce\ecormece\ecomerce\resources\views/cadastro.blade.php ENDPATH**/ ?>